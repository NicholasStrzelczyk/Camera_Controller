...
def capture_routine():
	...
	while time.monotonic_ns() - start_time < 6e10:
...
if __name__ == '__main__':
	...
	video_duration = 60  # seconds during which the video is being recorded (default is 1 min)
	...
	schedule.every(2).minutes.do(capture_routine)
