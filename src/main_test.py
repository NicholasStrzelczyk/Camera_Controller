...
def capture_routine():
	...
	if fail_counter > 0:
		log("failed to grab frame {} times during this block".format(fail_counter), logging.ERROR)
...
if __name__ == '__main__':
	...
	data_dir = "./new_data"  # base data location
	...
	schedule_times = [  # ranges from 6am to 12am
